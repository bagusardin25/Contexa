...
/** Starts Google OAuth on the server (PKCE verifier goes into a cookie), then leaves for Google. */
export function GoogleButton({ next, disabled = false }: { next: string; disabled?: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        {pending ? <LoaderCircleIcon className="motion-safe:animate-spin" aria-hidden /> : <GoogleMark />}
